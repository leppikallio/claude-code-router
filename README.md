**Please see the [upstream](https://github.com/musistudio/claude-code-router) for the truly up-to-date version of this marvellous tool.** This fork might well be doing silly things, be very old / erratically maintained. Overall typical [Tuonela](https://tuone.la) thing.

In case you _are_ in here, though, consider supporting and sponsoring the work in upstream:
